...
- Check that database column names, constraint values, and API contracts in source code match the L4 design specifications, including any schema migrations
